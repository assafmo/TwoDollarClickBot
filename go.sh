...
# visit "Get Paid To Click" & get links
...
while read path; do
	...
	# save the iframe's html because it contains the captcha and the captcha's variables 
	...
	# wait 10 seconds because of a server side time verification
	sleep "10.$RANDOM"

	# forge verification request
