...
echo 'visit "Get Paid To Click" & get links'
...
while read path; do
	echo 'visit link & get iframe link'
	...
	echo "save the iframe's html because it contains the captcha and the captcha's variables" 
	...
	echo extract captcha variables
	...
	echo wait 10 seconds because of a server side time verification
	sleep "10.$RANDOM"

	echo forge verification request
	...
	echo print total account money
